...
// Group shifts by their time range (startTime and endTime)
const groupShiftsByTimeRange = (shifts: Shift[]) => {
  ...
  return Object.values(grouped); // Return an array of grouped shifts
};
